...
export default {
  data() {
    return {
      search: "",
      headers: [
        {text: "Código da Empresa",align: "left",sortable: false,value: "name"},
        { text: "Nome Fantasia", value: "calories" },
        { text: "Razão Social", value: "fat" },
        { text: "CNPJ", value: "carbs" },
        { text: "Sigla", value: "protein" },
        { text: "Tipo Empresa", value: "protein" },
        { text: "Ativa", value: "protein" }
      ],
      desserts: [
        {
          name: "Frozen Yogurt",
